---
name: create-lecture
description: Create a new Quarto RevealJS lecture from papers, existing slides, R scripts, and other materials. Guides the content creation process with notation consistency, pedagogical patterns, and collaborative iteration.
