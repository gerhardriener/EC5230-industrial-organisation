...
Why does commitment require the first-stage action to be **observable**? What happens to the Stackelberg outcome if the follower cannot verify $q_1$ before choosing $q_2$?
:::
...
The leader earns more than in Cournot and the follower earns less. Is this because the leader is more *capable*, or because the *structure* of sequential moves creates an advantage? Could the follower also benefit from moving first?
:::
